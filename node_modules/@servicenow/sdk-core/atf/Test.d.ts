...
import { incident } from '../tables/incident';
 ...
 */
type ATFTableType = ATFType<typeof incident>;
...
export declare function Test(testName: string, configurationFunction: (ATF: ATFTableType) => any): {
    readonly testName: string;
    readonly configurationFunction: (ATF: ATFTableType) => any;
} & {
