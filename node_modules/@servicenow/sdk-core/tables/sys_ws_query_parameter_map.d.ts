...
export type sys_ws_query_parameter_map = typeof sys_ws_query_parameter_map;
export declare const sys_ws_query_parameter_map: {
    readonly name: "sys_ws_query_parameter_map";
    readonly extends: {
    ...
    readonly schema: {
        readonly web_service_operation: import("../db").Typed<string | import("../db").Record<{
        ...
        readonly web_service_query_parameter: import("../db").Typed<string | import("../db").Record<{
            readonly name: "sys_ws_query_parameter";
        }>, {
            readonly referenceTable: {
                readonly name: "sys_ws_query_parameter";
            };
