...
export type sys_ws_version = typeof sys_ws_version;
export declare const sys_ws_version: {
    readonly name: "sys_ws_version";
    readonly extends: {
    ...
    readonly schema: {
        ...
        readonly deprecated: import("../db").Typed<boolean, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly is_default: import("../db").Typed<boolean, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly short_description: import("../db").Typed<string, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly version: import("../db").Typed<number, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly version_id: import("../db").Typed<string, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
