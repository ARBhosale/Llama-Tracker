...
export type sys_ux_page_registry = typeof sys_ux_page_registry;
export declare const sys_ux_page_registry: {
    readonly name: "sys_ux_page_registry";
    readonly extends: {
    ...
    readonly schema: {
        ...
        readonly admin_panel_table: import("../db").Typed<Table, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly admin_panel: import("../db").Typed<import("../db").Record, {
            readonly dependent: import("../db").Typed<Table, {}> & {
                readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
            };
        }> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly parent_app: import("../db").Typed<string, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly path: import("../db").Typed<string, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly root_macroponent: import("../db").Typed<string, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
    };
};
