...
export type sys_user_role_contains = typeof sys_user_role_contains;
export declare const sys_user_role_contains: {
    readonly name: "sys_user_role_contains";
    readonly extends: {
    ...
    readonly schema: {
        readonly contains: import("../db").Typed<string | import("../db").Record<{
        ...
        readonly role: import("../db").Typed<string | import("../db").Record<{
            readonly name: "sys_user_role";
            readonly extends: {
                readonly name: "sys_metadata";
                readonly schema: {
