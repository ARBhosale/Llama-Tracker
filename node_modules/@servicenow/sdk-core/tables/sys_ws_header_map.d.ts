...
export type sys_ws_header_map = typeof sys_ws_header_map;
export declare const sys_ws_header_map: {
    readonly name: "sys_ws_header_map";
    readonly extends: {
    ...
    readonly schema: {
        readonly web_service_header: import("../db").Typed<string | import("../db").Record<{
            readonly name: "sys_ws_header";
        }>, {
            readonly referenceTable: {
                readonly name: "sys_ws_header";
            };
