...
export declare const sys_dictionary: {
    readonly name: "sys_dictionary";
    readonly extends: {
    ...
    readonly schema: {
        ...
        readonly attributes: import("../db").Typed<string, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly display_name: import("../db").Typed<string, {}> & {
            readonly asRecord: () => import("../entity").Entity<import("../db").Record<Table>, Table>;
        };
        readonly active: import("../db").Typed<boolean, {
            readonly default: true;
...
export declare const string_dynamic_value_mapping: {
    'Current Name': string;
