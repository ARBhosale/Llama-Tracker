...
export declare const ExperienceSchema: z.ZodObject<{
    ...
    baseUrlPath: z.ZodDefault<z.ZodString>;
...
export type ExperienceConfig = z.input<typeof ExperienceSchema>;
export declare function Experience(experience: ExperienceConfig): {
    name: string;
    description: string;
    active: boolean;
    baseUrlPath: string;
