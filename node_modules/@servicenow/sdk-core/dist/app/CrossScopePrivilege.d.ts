...
export declare const CrossScopePrivilegeSchema: z.ZodObject<{
...
export type CrossScopePrivilege = z.output<typeof CrossScopePrivilegeSchema>;
export type CrossScopePrivilegeConfig = z.input<typeof CrossScopePrivilegeSchema>;
export declare function CrossScopePrivilege(config: CrossScopePrivilegeConfig): {
    status: string;
    operation: string;
    target_name: string;
    target_scope: string;
    ...
    readonly asRecord: () => Entity<{
        readonly table: {
            readonly name: "sys_scope_privilege";
            readonly extends: {
            ...
            readonly schema: {
                readonly operation: import("../db").Typed<string, {}> & {
                    readonly asRecord: () => never;
                };
                readonly status: import("../db").Typed<string, {}> & {
                    readonly asRecord: () => never;
                };
                readonly source_scope: import("../db").Typed<string, {}> & {
                    readonly asRecord: () => never;
                };
                readonly target_name: import("../db").Typed<string, {}> & {
                    readonly asRecord: () => never;
                };
                readonly target_scope: import("../db").Typed<string, {}> & {
                    readonly asRecord: () => never;
                };
                readonly target_type: import("../db").Typed<string, {}> & {
                    readonly asRecord: () => never;
                };
            };
        } & {
