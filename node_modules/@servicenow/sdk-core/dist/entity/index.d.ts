 ...
 * database records.
 */
export type Entity<D extends object = object, R extends Record = Record> = D & {
    /**
 ...
 */
export declare function Entity<const E extends object, const R extends Record>(entity: E, asRecord: (this: E, entity: E) => Entity<R>): E & {
